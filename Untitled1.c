...
int main(int argc, const char* argv[])
{
    char a[100];
    char b[100];
    char lat[9],lon[9],spe[6],course[6],days[7],time[7], satellite[3],altituden[5];//lat纬度 lon经度 spe速度 course航向 day年月日 time时间 卫星数量，海拔高度
    FILE *fr,*fw;
    int i;
    int numbig,numsm,year,month,day,hour,minute,second;//年月日转换变量
    double speed;
